...
Site web Fluance Pro (cedricv.com) - Accompagnement pour entrepreneurs et indépendants.  
Site statique multilingue (FR/EN) construit avec [Eleventy](https://www.11ty.dev/) et [Tailwind CSS](https://tailwindcss.com/).  
Conçu pour être simple à développer en local, déployer sur un hébergement statique (GitHub Pages, Netlify, etc.), et facile à maintenir dans le temps.
