...
> **Note sur le chemin** : les endpoints sont servis sous le chemin standard `/.well-known/*` (RFC 8615). L'ancien chemin `/well-known/*` (sans point) redirige en 301 vers `/.well-known/*` via `src/_redirects`.
