  ...
  <article class="prose prose-lg max-w-none space-y-8 text-[#1f1f1f]">
    <div class="section-card p-8 bg-white space-y-4">
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          <h2 class="text-xl font-semibold text-[#0A6BCE] mb-2">Vos informations de connexion</h2>
    ...
    <div class="section-card p-8 bg-white space-y-6">
      <div class="text-center space-y-4">
        <h2 class="text-2xl font-semibold text-[#0A6BCE]">En guise de cadeau de bienvenue</h2>
        <p class="text-lg text-[#0f172a]/80">
    ...
    <div class="section-card p-8 bg-white space-y-6">
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          <h2 class="text-xl font-semibold text-[#0A6BCE] mb-4">Envie de partager cette aventure avec un proche que cela pourrait inspirer, aider ou soutenir ?</h2>
          <p class="text-lg text-[#0f172a]/80">
    ...
    <div class="text-center space-y-4 pt-8">
      ...
      <p class="text-xl font-semibold text-[#0A6BCE]">Cédric Vonlanthen</p>
    ...
    <div class="section-card p-8 bg-[#0A6BCE]/5 border-l-4 border-[#0A6BCE] rounded-r-lg space-y-4">
      <h2 class="text-xl font-semibold text-[#0A6BCE]">Besoin d'aide ?</h2>
      <p class="text-[#0f172a]/80">
        Contactez-moi via <a href="#" id="confirmation-email-link" class="text-[#0A6BCE] font-semibold hover:underline"></a> ou <a href="{{ '/contact/' | relativeUrl }}" class="text-[#0A6BCE] font-semibold hover:underline">cette page</a>.
      </p>
    </div>
  </article>
</section>
