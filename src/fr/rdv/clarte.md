  ...
  <section class="section-card p-8 bg-white space-y-6">
    ...
    <div class="max-w-2xl mx-auto space-y-4">
      <div class="border-l-4 border-[#0A6BCE] pl-4 py-2">
        <h3 class="font-semibold text-[#0A6BCE] mb-1">RDV Clarté : mardi 2 juin 2026</h3>
        <p class="text-[#0f172a]/80 text-sm"><strong>À 13h30</strong> (heure de France/Suisse/Belgique)</p>
