...
<section id="hero" class="relative min-h-screen flex items-center justify-end px-6 md:px-12 pt-32 pb-20 overflow-hidden -mt-28">
  <div class="absolute inset-0 z-0">
    ...
    <div class="absolute inset-0 bg-gradient-to-r from-transparent via-[#4a7cb8]/75 to-[#356DAE] md:via-[#4a7cb8]/75 md:to-[#356DAE]"></div>
  ...
  <div class="relative z-10 max-w-2xl text-white space-y-8">
    <div class="space-y-4">
      ...
      <p class="text-lg md:text-xl text-white drop-shadow-[0_2px_6px_rgba(0,0,0,0.7)] md:drop-shadow-none">
...
<section id="choisissez-votre-abonnement" class="max-w-6xl mx-auto px-6 md:px-12 py-16 space-y-8" style="scroll-margin-top: 100px;">
  <div class="text-center space-y-4 mb-12">
    <h2 class="text-3xl font-semibold text-[#0A6BCE]">Choisissez votre abonnement</h2>
    <p class="text-lg text-[#0f172a]/80">Deux options flexibles pour intégrer Fluance dans votre quotidien</p>
  </div>

  <div class="flex flex-col md:flex-row gap-8">
    <!-- Option 1: Mensuel -->
    <div class="section-card p-8 bg-white border-2 border-[#0A6BCE]/20 hover:border-[#0A6BCE]/40 transition-all flex-1">
      <div class="space-y-4">
        <div class="text-center">
          <h3 class="text-2xl font-semibold text-[#0A6BCE] mb-2">Formule mensuelle</h3>
          <p class="text-3xl font-bold text-[#0A6BCE]">30 CHF</p>
          <p class="text-lg text-[#0f172a]/80">/ équivalent € par mois</p>
        </div>
        <div class="pt-4 border-t border-[#0A6BCE]/20">
          <p class="text-lg text-[#0f172a]/80 text-center mb-6">
            <strong class="text-[#0A6BCE]">Les 14 premiers jours sont offerts</strong>
          </p>
          ...
          <p class="text-sm text-[#0f172a]/70 text-center mt-2">
            Résiliable à tout moment avec un simple e-mail à <a href="#" id="cancel-email-link-1" class="text-[#0A6BCE] hover:underline"></a>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="section-card p-8 bg-white border-2 border-[#0A6BCE] hover:border-[#0A6BCE]/80 transition-all flex-1 relative">
      <div class="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
        <span class="bg-[#0A6BCE] text-white px-4 py-1 rounded-full text-sm font-semibold whitespace-nowrap">La plus populaire</span>
      </div>
      <div class="space-y-4 pt-6">
        <div class="text-center">
          <h3 class="text-2xl font-semibold text-[#0A6BCE] mb-2">Formule trimestrielle</h3>
          <p class="text-3xl font-bold text-[#0A6BCE]">25 CHF</p>
          <p class="text-lg text-[#0f172a]/80">/ équivalent € par mois</p>
        ...
        <div class="pt-4 border-t border-[#0A6BCE]/20">
          ...
          <p class="text-sm text-[#0f172a]/70 text-center mt-2">
            Résiliable à tout moment avec un simple e-mail à <a href="#" id="cancel-email-link-2" class="text-[#0A6BCE] hover:underline"></a>
          </p>
        </div>
      </div>
    </div>
