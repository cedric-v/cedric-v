...
<section class="max-w-7xl mx-auto px-4 md:px-6 lg:px-12 py-16 space-y-12">
    ...
    <div class="section-card p-6 md:p-8 bg-white flex flex-col flex-1">
      <div class="text-center mb-6">
        ...
        <div class="text-center py-4 border-t border-b border-[#0A6BCE]/20">
          ...
          <p class="text-sm text-[#0f172a]/60">ou équivalent €</p>
        </div>
      </div>
      ...
      <div class="space-y-4 mb-6">
        ...
        <div class="border-l-4 border-[#ffce2d] pl-4">
          ...
          <ul class="space-y-2 text-[#0f172a]/80 text-sm">
            <li>• Résoudre un problème précis et urgent</li>
            <li>• Obtenir des conseils ciblés rapidement</li>
            <li>• Clarifier une situation bloquante</li>
          </ul>
        </div>
      </div>
    ...
    <div class="section-card p-6 md:p-8 bg-white border-2 border-[#0A6BCE] flex flex-col flex-1 relative">
      ...
      <div class="space-y-4 mb-6">
        <div class="border-l-4 border-[#0A6BCE] pl-4">
          <h3 class="font-semibold text-[#0A6BCE] mb-2">Ce que tu reçois :</h3>
          <ul class="space-y-2 text-[#0f172a]/80 text-sm">
            <li>• 3 sessions de coaching-consulting-mentoring (première session : 1h30 pour l'audit, puis 60 min chacune)</li>
            <li>• Accès aux rediffusions</li>
            <li>• Support par WhatsApp entre les sessions</li>
            <li>• Plan d'action personnalisé</li>
            <li>• Suivi sur 2-3 mois</li>
          </ul>
        </div>
  ...
  <section class="section-card p-8 bg-[#0A6BCE]/5 border-l-4 border-[#0A6BCE] rounded-r-lg">
    <h2 class="text-2xl font-semibold text-[#0A6BCE] mb-4">Questions fréquentes</h2>
  ...
  <section class="text-center space-y-6">
    <div class="pt-6 pb-4">
      <a href="{{ '/accompagnement/individuel/#temoignages' | relativeUrl }}" class="inline-flex items-center gap-2 border-2 border-[#0A6BCE] text-[#0A6BCE] rounded-full px-7 py-3.5 font-semibold hover:bg-[#0A6BCE] hover:text-white transition-colors">
