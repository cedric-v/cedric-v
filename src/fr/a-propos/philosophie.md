...
<section class="max-w-4xl mx-auto px-6 md:px-12 py-16 space-y-8">
  ...
  <article class="prose prose-lg max-w-none space-y-8 text-[#1f1f1f]">
      <div class="space-y-4">
      <h2 class="text-2xl font-semibold text-[#0A6BCE]">L'éveil ne demande pas de quitter le monde, mais de l'habiter pleinement.
      </h2>
    ...
    <div class="space-y-4 pt-6 border-t border-[#0A6BCE]/10">
      <h2 class="text-2xl font-semibold text-[#0A6BCE]">Vos tensions sont des leviers</h2>
      <p class="text-lg text-[#0f172a]/75 leading-relaxed">
    ...
    <div class="space-y-4 pt-6 border-t border-[#0A6BCE]/10">
      <h2 class="text-2xl font-semibold text-[#0A6BCE]">Tout est déjà en vous</h2>
      <p class="text-lg text-[#0f172a]/75 leading-relaxed">
    ...
    <div class="space-y-4 pt-6 border-t border-[#0A6BCE]/10">
      <h2 class="text-2xl font-semibold text-[#0A6BCE]">Une porte d'accès joyeuse</h2>
      <p class="text-lg text-[#0f172a]/75 leading-relaxed">
