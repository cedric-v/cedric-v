  ...
  <article class="space-y-12">
    ...
    <div class="section-card p-8 bg-white space-y-4">
      ...
      <ul class="space-y-4 text-[#0f172a]/75">
        ...
        <li class="flex items-start gap-3">
          <span class="text-[#0A6BCE] font-bold text-xl shrink-0">✓</span>
          <span><strong><span data-tooltip="A 'time machine' for your website that records the history of every single change made." title="A 'time machine' for your website that records the history of every single change made." class="cursor-help" tabindex="0">Git</span> hosting & <span data-tooltip="The process of keeping a complete record of your website's history, allowing you to compare or restore any previous state." title="The process of keeping a complete record of your website's history, allowing you to compare or restore any previous state." class="cursor-help" tabindex="0">versioning</span>:</strong> your entire site is backed up and versioned on a <strong data-tooltip="A 'time machine' for your website that records the history of every single change made." title="A 'time machine' for your website that records the history of every single change made." class="cursor-help" tabindex="0">Git</strong> server. Every modification creates an archive: a mistake? We revert to the previous version in seconds.</span>
        </li>
        <li class="flex items-start gap-3">
          <span class="text-[#0A6BCE] font-bold text-xl shrink-0">✓</span>
