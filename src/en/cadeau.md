...
<section class="max-w-4xl mx-auto px-6 md:px-12 py-16 space-y-12">
  ...
  <article class="prose prose-lg max-w-none space-y-12 text-[#1f1f1f]">
    ...
    <div class="space-y-12">
      <!-- Video 1: Recharge -->
      <div class="section-card p-8 bg-white space-y-6">
        <h3 class="text-2xl font-semibold text-[#0A6BCE] text-center">Recharge</h3>
      ...
      <div class="section-card p-8 bg-white space-y-6">
        <h3 class="text-2xl font-semibold text-[#0A6BCE] text-center">Take a step back</h3>
      ...
      <div class="section-card p-8 bg-white space-y-6">
        <h3 class="text-2xl font-semibold text-[#0A6BCE] text-center">Ground yourself</h3>
