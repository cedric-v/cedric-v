...
<section id="choose-your-subscription" class="max-w-6xl mx-auto px-6 md:px-12 py-16 space-y-8" style="scroll-margin-top: 100px;">
  <div class="text-center space-y-4 mb-12">
    <h2 class="text-3xl font-semibold text-[#0A6BCE]">Choose your subscription</h2>
  ...
  <div class="flex flex-col md:flex-row gap-8">
    ...
    <div class="section-card p-8 bg-white border-2 border-[#0A6BCE]/20 hover:border-[#0A6BCE]/40 transition-all flex-1">
      <div class="space-y-4">
        <div class="text-center">
          <h3 class="text-2xl font-semibold text-[#0A6BCE] mb-2">Monthly plan</h3>
        ...
        <div class="pt-4 border-t border-[#0A6BCE]/20">
          <p class="text-lg text-[#0f172a]/80 text-center mb-6">
            <strong class="text-[#0A6BCE]">The first 14 days are free</strong>
          </p>
          ...
          <p class="text-sm text-[#0f172a]/70 text-center mt-2">
            Cancelable at any time with a simple email to <a href="#" id="cancel-email-link-en-1" class="text-[#0A6BCE] hover:underline"></a>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="section-card p-8 bg-white border-2 border-[#0A6BCE] hover:border-[#0A6BCE]/80 transition-all flex-1 relative">
      <div class="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
        <span class="bg-[#0A6BCE] text-white px-4 py-1 rounded-full text-sm font-semibold whitespace-nowrap">Most popular</span>
      </div>
      <div class="space-y-4 pt-6">
        <div class="text-center">
          <h3 class="text-2xl font-semibold text-[#0A6BCE] mb-2">Quarterly plan</h3>
        ...
        <div class="pt-4 border-t border-[#0A6BCE]/20">
          ...
          <p class="text-sm text-[#0f172a]/70 text-center mt-2">
            Cancelable at any time with a simple email to <a href="#" id="cancel-email-link-en-2" class="text-[#0A6BCE] hover:underline"></a>
          </p>
        </div>
      </div>
    </div>
