...
<section id="contact" class="max-w-4xl mx-auto px-6 md:px-12 py-16 space-y-8">
  <div class="section-card p-8 bg-white text-center space-y-6 rounded-xl">
     <h1 class="text-3xl font-semibold text-[#0A6BCE] mb-8">Contact Cédric</h1>
  ...
  <div class="section-card p-8 bg-white space-y-6 rounded-xl">
    <div>
     ...
     <div class="py-8 border-t border-[#0A6BCE]/20">
       <h2 class="text-xl font-semibold text-[#0A6BCE] mb-3">Email</h2>
      <p class="text-[#0f172a]/80">
        <a href="#" id="contact-email-link-en" class="text-[#0A6BCE] hover:underline"></a>
      </p>
    </div>

     <div class="py-8 border-t border-[#0A6BCE]/20">
       <h2 class="text-xl font-semibold text-[#0A6BCE] mb-3">Address</h2>
      <p class="text-[#0f172a]/80">
