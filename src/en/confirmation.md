  ...
  <article class="prose prose-lg max-w-none space-y-8 text-[#1f1f1f]">
    <div class="section-card p-8 bg-white space-y-4">
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          <h2 class="text-xl font-semibold text-[#0A6BCE] mb-2">Your login information</h2>
    ...
    <div class="section-card p-8 bg-white space-y-6">
      <div class="text-center space-y-4">
        <h2 class="text-2xl font-semibold text-[#0A6BCE]">As a welcome gift</h2>
        <p class="text-lg text-[#0f172a]/80">
    ...
    <div class="section-card p-8 bg-white space-y-6">
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          <h2 class="text-xl font-semibold text-[#0A6BCE] mb-4">Would you like to share this adventure with someone close who might be inspired, helped or supported by it?</h2>
          <p class="text-lg text-[#0f172a]/80">
    ...
    <div class="section-card p-8 bg-[#0A6BCE]/5 border-l-4 border-[#0A6BCE] rounded-r-lg space-y-4">
      <h2 class="text-xl font-semibold text-[#0A6BCE]">Need help?</h2>
      <p class="text-[#0f172a]/80">
        Contact me via <a href="#" id="confirmation-email-link-en" class="text-[#0A6BCE] font-semibold hover:underline"></a> or <a href="{{ '/en/contact/' | relativeUrl }}" class="text-[#0A6BCE] font-semibold hover:underline">this page</a>.
      </p>
    </div>
  </article>
</section>
