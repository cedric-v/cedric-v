...
<section class="max-w-4xl mx-auto px-6 md:px-12 py-12 space-y-8">
  <header class="space-y-2 text-center">
    <p class="cta-pill bg-[#0A6BCE]/10 text-[#0A6BCE] inline-flex">Information légale</p>
...
Dans le cadre de notre activité sur cedricv.com (ci-après le « Site »), vous nous transmettez les informations suivantes en remplissant le(s) formulaire(s) de renseignement et en communiquant avec nous :
